...
Permitir associar tags a uma nota e listar notas por tag, pra organizar conforme o volume
cresce.
...
> Nomes de arquivo/símbolo: o agente confirma no código (a spec assume `notes.ts` e a
> migração em `db/`, mas é hipótese).
